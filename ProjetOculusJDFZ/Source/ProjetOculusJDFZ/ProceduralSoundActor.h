...
private: 
	...
	*	@param InPoints: The point of a polyline we will rotate to have the revolution object
	*	@param InSegments: How many iteration for the rotation. Higher it is less you see the face
