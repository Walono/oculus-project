...
void FakeServer::addFaceToLibrary(FVector pos, TArray<FVector> face,
	int texture, int id)
{
...
void FakeServer::addSoundToLibrary(std::string name, FVector pos,
	FVector viewDirection, FVector upDirection, int id)
{
	...
	library->add_sound_source(name, soundPosition, soundViewDirection,
		soundUpDirection, id);
}
...
void FakeServer::startSendingData()
{
	...
	floorcoord.Add(FVector((23 * unitLength) + 400.f,
		(16 * unitWidth) + 400.f, 0.f));
	...
	addFaceToLibrary(FVector(22 * unitLength, 16 * unitWidth, 0.f),
		littleOutsideEastCoord, 0, 4);
	...
	addFaceToLibrary(FVector(23 * unitLength, 0.f, 0.f),
		outsideNorthCoord, 0,5);
	...
	addFaceToLibrary(FVector(2* unitLength, 0.f, 0.f),
		entranceNorthCoord, 0, 9);
	...
	addFaceToLibrary(FVector(2 * unitLength, 14 * unitWidth, 0.f),
		entranceNeedleCoord, 0, 10);
	...
	addFaceToLibrary(FVector(unitLength, 15 * unitWidth, 0.f),
		entranceFrontCoord, 0, 11);
	...
	addFaceToLibrary(FVector(4 * unitLength, 11 * unitWidth, 0.f),
		entranceEndUCoord, 0, 12);
	...
	addFaceToLibrary(FVector(3 * unitLength, 10 * unitWidth, 0.f),
		entranceEndNeedleCoord, 0, 13);
	...
	addFaceToLibrary(FVector(19 * unitLength, 11 * unitWidth, 0.f),
		doubleBigNeedleFirstSpikeCoord, 0, 16);
	...
	addFaceToLibrary(FVector(17 * unitLength, 13 * unitWidth, 0.f),
		doubleBigNeedleSecondSpikeCoord, 0, 17);
	...
	addFaceToLibrary(FVector(16 * unitLength, 12 * unitWidth, 0.f),
		doubleBigNeedleMiddleWestCoord, 0, 18);
	...
	addFaceToLibrary(FVector(17 * unitLength, 13 * unitWidth, 0.f),
		doubleBigNeedleMiddleEastCoord, 0, 19);
	...
	addFaceToLibrary(FVector(17 * unitLength, 14 * unitWidth, 0.f),
		doubleBigNeedleSecondEndCoord, 0, 20);
	...
	addFaceToLibrary(FVector(20 * unitLength, 14 * unitWidth, 0.f),
		doubleBigNeedleWrongEndCoord, 0, 21);
	...
	addFaceToLibrary(FVector(20 * unitLength, 7 * unitWidth, 0.f),
		doubleBigNeedleBigWallCoord, 0, 22);
	...
	addFaceToLibrary(FVector(16 * unitLength, 12 * unitWidth, 0.f),
		doubleBigNeedleSouthWallCoord, 0, 23);
	...
	addFaceToLibrary(FVector(14 * unitLength, 15 * unitWidth, 0.f),
		doubleBigNeedleEasthWallCoord, 0, 24);
	...
	addFaceToLibrary(FVector(15 * unitLength, 14 * unitWidth, 0.f),
		middleNorthNeedleSpikeCoord, 0, 25);
	...
	addFaceToLibrary(FVector(15 * unitLength, 12 * unitWidth, 0.f),
		middleNorthNeedleSouthWallCoord, 0, 26);
	...
	addFaceToLibrary(FVector(14 * unitLength, 13 * unitWidth, 0.f),
		ThreeRedCircleNorth, 0, 27);
	...
	addFaceToLibrary(FVector(6 * unitLength, 13 * unitWidth, 0.f),
		ThreeRedCircleWest, 0, 28);
	...
	addFaceToLibrary(FVector(13 * unitLength, 14 * unitWidth, 0.f),
		ThreeRedCircleSouth, 0, 29);
	...
	addFaceToLibrary(FVector(5 * unitLength, 12 * unitWidth, 0.f),
		FrontThreeRedCircleWest, 0, 30);
	...
	addFaceToLibrary(FVector(6 * unitLength, 14 * unitWidth, 0.f),
		middleEastWrongWayWestWall, 0, 31);
	...
	addFaceToLibrary(FVector(5 * unitLength, 15 * unitWidth, 0.f),
		middleEastWrongWayEastWall, 0, 32);
	...
	addFaceToLibrary(FVector(5 * unitLength, 12 * unitWidth, 0.f),
		middleEastWrongWaySouthWall, 0, 33);
	...
	addFaceToLibrary(FVector(6 * unitLength, 13 * unitWidth, 0.f),
		middleEastWrongWayNeedleSpike, 0, 34);
	...
	addFaceToLibrary(FVector(19 * unitLength, 8 * unitWidth, 0.f),
		bigFloorLeftSouth, 0, 35);
	...
	addFaceToLibrary(FVector(18 * unitLength, 8 * unitWidth, 0.f),
		bigFloorLeftNeedleSpike, 0, 36);
	...
	addFaceToLibrary(FVector(5 * unitLength, 9 * unitWidth, 0.f),
		bigFloorWestOposit, 0, 38);
	...
	addFaceToLibrary(FVector(5 * unitLength, 8 * unitWidth, 0.f),
		midFloorSouth, 0, 39);
	...
	addFaceToLibrary(FVector(12 * unitLength, 8 * unitWidth, 0.f),
		midFloorMiddle, 0, 41);
	...
	addFaceToLibrary(FVector(14 * unitLength, 8 * unitWidth, 0.f),
		midFloorTopBot, 0, 42);
	...
	addFaceToLibrary(FVector(16 * unitLength, 8 * unitWidth, 0.f),
		midFloorTopTop, 0, 43);
	...
	addFaceToLibrary(FVector(17 * unitLength, 7 * unitWidth, 0.f),
		midFloorTopTopWest, 0, 44);
	...
	addFaceToLibrary(FVector(15 * unitLength, 7 * unitWidth, 0.f),
		midFloorTopBotWest, 0, 45);
	...
	addFaceToLibrary(FVector(16 * unitLength, 7 * unitWidth, 0.f),
		midFloorTopTopSouth, 0, 46);
	...
	addFaceToLibrary(FVector(14 * unitLength, 6 * unitWidth, 0.f),
		midFloorTopBotSouth, 0, 49);
	...
	addFaceToLibrary(FVector(13 * unitLength, 5 * unitWidth, 0.f),
		midFloorMiddleNorth, 0, 50);
	...
	addFaceToLibrary(FVector(12 * unitLength, 4 * unitWidth, 0.f),
		midFloorMiddleSouth, 0, 51);
	...
	addFaceToLibrary(FVector(11 * unitLength, 2 * unitWidth, 0.f),
		midFloorMiddleFrontSouth, 0, 52);
	...
	addFaceToLibrary(FVector(10 * unitLength, 2 * unitWidth, 0.f),
		midFloorMiddleFrontSouthOposit, 0, 53);
	...
	addFaceToLibrary(FVector(4 * unitLength, 7 * unitWidth, 0.f),
		midSouthWrongWayNorth, 0, 54);
	...
	addFaceToLibrary(FVector(3 * unitLength, 6 * unitWidth, 0.f),
		midSouthWrongWaySouth, 0, 55);
	...
	addFaceToLibrary(FVector(3 * unitLength, 9 * unitWidth, 0.f),
		midSouthWrongWayEast, 0, 56);
	...
	addFaceToLibrary(FVector(3 * unitLength, 6 * unitWidth, 0.f),
		beforMidSouthWrongWayWest, 0, 57);
	...
	addFaceToLibrary(FVector(4 * unitLength, 7 * unitWidth, 0.f),
		beforMidSouthWrongWayEast, 0, 58);
	...
	addFaceToLibrary(FVector(12 * unitLength, 3 * unitWidth, 0.f),
		fiveNeedleFirstSpike, 0, 59);
	...
	addFaceToLibrary(FVector(12 * unitLength, 4 * unitWidth, 0.f), 
		fiveNeedleFirstSpikeOposit, 0, 60);
	...
	addFaceToLibrary(FVector(8 * unitLength, 2 * unitWidth, 0.f), 
		fiveNeedleThirdSpike, 0, 62);
	...
	addFaceToLibrary(FVector(6 * unitLength, 2 * unitWidth, 0.f), 
		fiveNeedleFourthSpike, 0, 63);
	...
	addFaceToLibrary(FVector(4 * unitLength, 3 * unitWidth, 0.f),
		fiveNeedleFivethSpike, 0, 64);
	...
	addFaceToLibrary(FVector(3 * unitLength, 1 * unitWidth, 0.f),
		fiveNeedleFivethSpikeWest, 0, 65);
	...
	addFaceToLibrary(FVector(5 * unitLength, 1 * unitWidth, 0.f), 
		fiveNeedleFirstthSpikeWest, 0, 66);
	...
	addFaceToLibrary(FVector(3 * unitLength, 5 * unitWidth, 0.f), 
		fiveNeedleFivethSpikeOposit, 0, 67);
	...
	addFaceToLibrary(FVector(7 * unitLength, 5 * unitWidth, 0.f), 
		fiveNeedleThirdSpikeEast, 0, 68);
	...
	addFaceToLibrary(FVector(4 * unitLength, 1 * unitWidth, 0.f), 
		fiveNeedleFivethSouth, 0, 69);
	...
	addFaceToLibrary(FVector(3 * unitLength, 1 * unitWidth, 0.f), 
		fiveNeedleFivethSouthOposit, 0, 70);
	...
	addFaceToLibrary(FVector(7 * unitLength, 2 * unitWidth, 0.f),
		fiveNeedleFourthNorth, 0, 72);
	...
	addFaceToLibrary(FVector(9 * unitLength, 2 * unitWidth, 0.f), 
		fiveNeedleThirdNorth, 0, 74);
	...
	addFaceToLibrary(FVector(12 * unitLength, 1 * unitWidth, 0.f), 
		fiveNeedleFirstSouth, 0, 75);
	...
	addFaceToLibrary(FVector(13 * unitLength, 1 * unitWidth, 0.f), 
		fiveNeedleFirstNorth, 0, 76);
	...
	addFaceToLibrary(FVector(14 * unitLength, 2 * unitWidth, 0.f), 
		fiveNeedleFirstNorthOposit, 0, 77);
	...
	addFaceToLibrary(FVector(22 * unitLength, 1 * unitWidth, 0.f), 
		lastLNorth, 0, 80);
	...
	addFaceToLibrary(FVector(21 * unitLength, 2 * unitWidth, 0.f),
		lastLSouth, 0, 81);
	...
	addFaceToLibrary(FVector(19 * unitLength, 3 * unitWidth, 0.f), 
		twoNeedleNorthWestEndWest, 0, 83);
	...
	addFaceToLibrary(FVector(17 * unitLength, 6 * unitWidth, 0.f),
		twoNeedleNorthWestEndWestOposit, 0, 84);
	...
	addFaceToLibrary(FVector(18 * unitLength, 5 * unitWidth, 0.f), 
		twoNeedleNorthWestFirstNeedleSpike, 0, 85);
	...
	addFaceToLibrary(FVector(16 * unitLength, 4 * unitWidth, 0.f), 
		twoNeedleNorthWestSecondNeedleSpike, 0, 86);
	...
	twoNeedleNorthWestSecondNeedleSpikeOposit.Add(FVector(3 * unitLength,
		0.f, unitHigh));
	twoNeedleNorthWestSecondNeedleSpikeOposit.Add(FVector(3 * unitLength,
		0.f, 0.f));
	addFaceToLibrary(FVector(15 * unitLength, 3 * unitWidth, 0.f),
		twoNeedleNorthWestSecondNeedleSpikeOposit, 0, 87);
	...
	addFaceToLibrary(FVector(13 * unitLength, 5 * unitWidth, 0.f),
		twoNeedleNorthWestEntranceWest, 0, 88);
	...
	twoNeedleNorthWestEntranceWestOposit.Add(FVector(2 * unitLength,
		0.f, unitHigh));
	twoNeedleNorthWestEntranceWestOposit.Add(FVector(2 * unitLength, 0.f, 0.f));
	addFaceToLibrary(FVector(14 * unitLength, 6 * unitWidth, 0.f),
		twoNeedleNorthWestEntranceWestOposit, 0, 89);
	...
	twoNeedleNorthWestSecondNeedleSouth.Add(FVector(0.f, 2 * unitWidth,
		unitHigh));
	twoNeedleNorthWestSecondNeedleSouth.Add(FVector(0.f, 2 * unitWidth, 0.f));
	addFaceToLibrary(FVector(16 * unitLength, 4 * unitWidth, 0.f),
		twoNeedleNorthWestSecondNeedleSouth, 0, 90);
	...
	twoNeedleNorthWestSecondNeedleNorth.Add(FVector(0.f, 2 * unitWidth,
		unitHigh));
	twoNeedleNorthWestSecondNeedleNorth.Add(FVector(0.f, 2 * unitWidth, 0.f));
	addFaceToLibrary(FVector(17 * unitLength, 4 * unitWidth, 0.f), 
		twoNeedleNorthWestSecondNeedleNorth, 0, 91);
	...
	twoNeedleNorthWestFirstNeedleSouth.Add(FVector(0.f,
		2 * unitWidth, unitHigh));
	twoNeedleNorthWestFirstNeedleSouth.Add(FVector(0.f, 2 * unitWidth, 0.f));
	addFaceToLibrary(FVector(18 * unitLength, 3 * unitWidth, 0.f),
		twoNeedleNorthWestFirstNeedleSouth, 0, 92);
	...
	twoNeedleNorthWestFirstNeedleNorth.Add(FVector(0.f,
		2 * unitWidth, unitHigh));
	twoNeedleNorthWestFirstNeedleNorth.Add(FVector(0.f, 2 * unitWidth, 0.f));
	addFaceToLibrary(FVector(19 * unitLength, 3 * unitWidth, 0.f),
		twoNeedleNorthWestFirstNeedleNorth, 0, 93);
	...
	twoNeedleNorthWestFirstNeedleNorthOposit.Add(FVector(0.f,
		3 * unitWidth, unitHigh));
	twoNeedleNorthWestFirstNeedleNorthOposit.Add(FVector(0.f,
		3 * unitWidth, 0.f));
	addFaceToLibrary(FVector(20 * unitLength, 3 * unitWidth, 0.f),
		twoNeedleNorthWestFirstNeedleNorthOposit, 0, 94);
	...
	twoNeedleNorthWestSecondNeedleSouthOposit.Add(FVector(0.f,
		2 * unitWidth, unitHigh));
	twoNeedleNorthWestSecondNeedleSouthOposit.Add(FVector(0.f,
		2 * unitWidth, 0.f));
	addFaceToLibrary(FVector(15 * unitLength, 3 * unitWidth, 0.f),
		twoNeedleNorthWestSecondNeedleSouthOposit, 0, 95);

	//add sound

	addSoundToLibrary("Sound1", FVector(1 * unitLength + 150.f,
		14 * unitWidth + 250.f, 100.f), FVector(0.f, -1.f, 0.f),
		FVector(0.f, 0.f, 1.f), 1);
	addSoundToLibrary("Sound1", FVector(19 * unitLength + 250.f,
		14 * unitWidth + 150.f, 100.f), FVector(-2.f, -1.f, 0.f),
		FVector(0.f, 0.f, 1.f), 2);
	addSoundToLibrary("Sound1", FVector(18 * unitLength + 50.f,
		7 * unitWidth + 150.f, 100.f), FVector(0.f, 2.f, 0.f),
		FVector(0.f, 0.f, 1.f), 3);
}